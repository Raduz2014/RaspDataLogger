...
aaa = Cork('/home/pi/RaspDataLogger/DataloggerWebApp/WebApi/v1/example_conf', email_sender='raduz18@@gmail.com', smtp_url='')
...
def main():
    ...
    bottle.debug(True)
    bottle.run(app=app, host='localhost', port=98, quiet=False, reloader=True)

if __name__ == "__main__":
    main()
else:
    #import test_webapi_dbsqlite
